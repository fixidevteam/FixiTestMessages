                ...
                <ol
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a
                                href="{{ route('admin.gestionCategorie.create') }}"
                                class="inline-flex items-center text-sm font-medium text-gray-700   ">
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <form  action="{{ route('admin.gestionCategorie.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <x-text-input id="nom_categorie" class="block mt-1 w-full" type="text" name="nom_categorie" :value="old('nom_categorie')" autofocus autocomplete="nom_categorie" />
