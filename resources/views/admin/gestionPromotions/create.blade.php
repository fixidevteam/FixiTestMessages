<x-admin-app-layout>
    <div class="p-4 sm:ml-64">
                ...
                <ol
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a
                                href="{{ route('admin.gestionPromotions.create') }}"
                                class="inline-flex items-center text-sm font-medium text-gray-700">
                                Ajouter promotion
                            </a>
                        </div>
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <h2 class="mt-10  text-2xl font-bold leading-9 tracking-tight text-gray-900">Ajouter promotion</h2>
            <form method="POST" action="{{ route('admin.gestionPromotions.store') }}" class="space-y-6" enctype="multipart/form-data">
                @csrf
                <div>
                    <x-input-label for="nom_promotion" :value="__('Promotion')" />
                    <x-text-input id="nom_promotion" class="block mt-1 w-full" type="text" name="nom_promotion" :value="old('nom_promotion')" autofocus autocomplete="nom_promotion" />
                ...
                <div>
                    ...
                    <x-text-input id="lien_promotion" class="block mt-1 w-full" type="text" name="lien_promotion" :value="old('lien_promotion')" autofocus autocomplete="lien_promotion" />
