        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between items-center my-6">
                    <h2 class="text-2xl font-bold leading-9 tracking-tight text-gray-900">Liste des promotions</h2>
                    <div>
                        <a href="{{ route('admin.gestionPromotions.create') }}">
                            <x-primary-button class="hidden md:block">Ajouter promotion</x-primary-button>
                ...
                <div class="my-5">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            <caption class="sr-only">Liste des promotions</caption>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.gestionPromotions.show',$promotion->id) }}">
                                            @if($promotion->photo_promotion !== NULL)
                                            <img class="rounded-full w-8 h-8 object-cover" src="{{asset('storage/'.$promotion->photo_promotion)}}" alt="promotion image">
                                            @else
                                            <img class="rounded-full w-8 h-8 object-cover" src="/images/defaultimage.jpg" alt="promotion image">
                                            @endif
                                        </a>
                                    </td>
                                    <td class="px-6 py-4">
                                        <a href="{{ route('admin.gestionPromotions.show',$promotion->id) }}" class="font-medium capitalize text-blue-600 dark:text-blue-500 hover:underline">détails</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
