        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            <div class="px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between items-center my-6">
                    <h2 class="text-2xl font-bold leading-9 tracking-tight text-gray-900">Liste des Papiers personnel</h2>
                    <a href="{{ route('admin.gestionPapierPerso.create') }}">
                        <x-primary-button class="hidden md:block">Ajouter Papier personnel</x-primary-button>
                    </a>
                </div>
                <div class="my-5">
                    {{-- alert --}}
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <!-- Edit Button -->
                                            <a href="{{ route('admin.gestionPapierPerso.edit', $type->id) }}" class="text-blue-500 flex items-center">
                                            ...
                                            <!-- Delete Button -->
                                            <button onclick="toggleModal(true, 'confirmationModal-{{ $type->id }}')" class="ml-5 text-red-500 flex items-center">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div id="confirmationModal-{{ $type->id }}" class="fixed inset-0 bg-white bg-opacity-30 backdrop-blur-[2px] flex items-center justify-center hidden">
                            <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
                                ...
                                <p class="text-gray-600 mt-2">Êtes-vous sûr de vouloir supprimer ce papier personnel ? Cette action ne peut pas être annulée.</p>
                                <div class="flex justify-end mt-4">
                                    <button onclick="toggleModal(false, 'confirmationModal-{{ $type->id }}')" class="px-4 py-2 bg-gray-300 text-gray-800 rounded mr-2">
                                        Annuler
                                    </button>
                                    <form action="{{ route('admin.gestionPapierPerso.destroy', $type->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
