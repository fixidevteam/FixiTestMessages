<footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
  ...
  <div class="flex sm:justify-center space-x-6">
      ...
      <a href="https://www.instagram.com/fiximaroc/" target="_blanck" class="text-gray-500 hover:text-gray-900">
          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <a href="https://www.linkedin.com/company/fixi-maroc" target="_blanck" class="text-gray-500 hover:text-gray-900">
...
<p class="text-center text-sm text-gray-500 my-10">
  &copy; 2024 <a href="https://fixi.ma/" class="hover:underline" target="_blank" rel="noopener">Fixi</a>. All rights reserved.
</p>